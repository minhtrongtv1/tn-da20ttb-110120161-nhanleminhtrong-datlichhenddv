...
class Mailer {
    public function datlichmail($tieude,$noidung,$maildatlich){
        try {
            ...
            $mail->addAddress('minhtrongtv123@gmail.com', 'Minh Trọng');     //Add a recipient
            $mail->addAddress('minhtrongtv123@gmail.com','Trường Đặng');               //Name is optional
            // $mail->addReplyTo('info@example.com', 'Information');
            $mail->addCC('minhtrongtv1@gmail.com');
