...
<body>
    ...
    <div class="container-fluid">
        <div class="container col-lg-7 mt-4">
            <div class="mb-5">
                <h2 style color="black">Lịch sử đặt lịch</h2>
                <ul class="list-group">
                    <?php
                    $sql_history = "SELECT * FROM tbl_booking, tbl_lichhen WHERE tbl_booking.id_lichhen=tbl_lichhen.id_lichhen AND tbl_booking.id_khachhang='$id_khachhang'";
