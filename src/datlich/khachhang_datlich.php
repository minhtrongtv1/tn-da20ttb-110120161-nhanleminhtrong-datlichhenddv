<?php 
    ...
    $current_date = date('Y-m-d'); 
     ...
     $sql= "SELECT * FROM `tbl_lichhen` WHERE id_vaitro='$id_vaitro' AND ngay >= '$current_date'";
            ...
            <?php if(mysqli_num_rows($res)>0){ ?>
                ...
                <div class="col-lg-4 mb-4">
                    ...
                    <span><img class="img-fluid" style="height:300px;" src="admin/images/<?php echo $row["hinhanh"]; ?>"  alt=""></span>
                        ...
                        <h5 class="text-white mb-3"style="width:100%;">Tên nhân viên: <?php echo $row["tenquanly"]; ?></h5> 
